 ...
 */
import type { GetApiV1AnalyticsTpsAutomatedScope } from "./getApiV1AnalyticsTpsAutomatedScope.ts";

export type GetApiV1AnalyticsTpsParams = {
  /**
   * Range start date
   */
  from?: string;
   ...
   * Automation scope
   */
  automated_scope?: GetApiV1AnalyticsTpsAutomatedScope;
  /**
